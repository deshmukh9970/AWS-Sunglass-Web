# Host multiple websites on an EC2 instance running an Nginx server and configure SSL for each website

#### Description:

- Create an EC2 instance.
- Install Nginx on the instance.
- Host multiple websites with various pages (e.g., about.html, contact.html) on the Nginx server.
...
#### Step-3: Host multiple websites with various pages (e.g., about.html, contact.html) on the Nginx server.
...
#### Step-4: Create an elastic IP and associate it with the EC2 instance.
...
#### Step-6: Set up an automation script for SSL certificate renewal.
